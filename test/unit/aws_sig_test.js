...
import aws_sig from "include/aws_sig.js";
import fs from "fs";
...
function testReadCredentialsWithAccessAndSecretKeySet() {
    ...
    try {
        var credentials = aws_sig.readCredentials(r);
...
function testReadAndWriteCredentialsFromKeyValStore() {
    ...
    try {
        ...
        aws_sig.writeCredentials(r, expectedCredentials);
        let credentials = JSON.stringify(aws_sig.readCredentials(r));
...
test();
console.log('Finished unit tests for aws_sig.js');
